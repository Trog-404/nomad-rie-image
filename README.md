![docker image](https://github.com/Trog-404/nomad-rie-image/actions/workflows/docker-publish.yml/badge.svg)


# Trog-404's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of Trog-404.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/Trog-404/nomad-rie-image.git
    cd nomad-rie-image
    ```
    ...
    ```sh
    curl-L -o nomad-rie-image.zip "https://github.com/Trog-404/nomad-rie-image/archive/main.zip"
    unzip nomad-rie-image.zip
    cd nomad-rie-image
    ```
...
your `docker-compose.yaml` with `ghcr.io/trog-404/nomad-rie-image:main` for the services
...
```
docker pull ghcr.io/trog-404/nomad-rie-image/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/Trog-404/nomad-rie-image/manifests/main": unauthorized`
